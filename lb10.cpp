...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// если выводит ошибку связанную с fopen_s то раскоменти эти две строки, если нет то я в вк писал как сделать без ошибки открытие
...
void main(){
	...
	if (!(f = fopen("text.txt", "r"))) { //открываем файл, если его нет то пишем "Файл не найден...." и закрываем консоль.
		...
		// если файл найден, тогда, работаем братья
